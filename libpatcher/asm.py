...
instruction(['AND', 'ANDS'], [Reg(), Reg(), Num.ThumbExpandable()], 4, lambda self,rd,rn,imm:
            (
                (0b11110<<11)+
                (imm.the(1,11)<<10)+
                ((1 if 'S' in self.opcode else 0)<<4)+
...
instruction('LDR', [Reg('LO'), [Reg('LO'), Reg('LO')]], 2, lambda self,rt,lst:
            ...
            (lst[0] << 3) +
            rt)
instruction(['LDR.W','LDR'], [Reg(), ([Reg(),Reg()], [Reg(),Reg(),Num(bits=2)])], 4, lambda self,rt,lst:
            ((0b11111 << 11) +
             (0b101 << 4) +
             lst[0],
             (rt << 12) +
...
# in T2
instruction(['LDRB','LDRB.W'], [Reg(), [Reg(), Num(bits=12)]], 4, lambda self,rt,rest:
            (
                (0b11111<<11)+
                (1<<7)+
                (1<<4)+
